...
export const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        author: 'Albert',
        description: 'A sailing community and regatta information hub for checking event rankings, race resources, sailor rankings, and training references.',
        tags: ['Tool', 'Sailing'],
        emoji: '⛵',
    ...
    },
    {
        ...
        title: 'C-Paper',
        author: '1ming',
        description: 'A CIE paper downloader for searching subject codes, seasons, paper types, mark schemes, and batch downloads.',
        tags: ['Tool', 'Classroom'],
        emoji: '📄',
        url: 'https://yiming.us/c-paper',
        accentColor: 'rgba(15, 118, 110, 0.16)',
        status: 'live',
    },
    {
